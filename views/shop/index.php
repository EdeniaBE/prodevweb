...
<?php }?>
			...
			<div id="shopping-cart" tabindex="1">
				<div id="tbl-cart">
					<div id="txt-heading">
						<div id="cart-heading">Votre Panier</div>
						<div id="close"></div>
					</div>
					<div id="cart-item">
        				<?php require_once './views/shop/shopping-cart.php'; ?>
           			 </div>
				</div>
			</div>

			<div class="payment-details">
				<div class="payment-details-heading">Details de payement</div>
				<div class="row">
					<div class="inline-block">
						<div>
							<input class="bank-transfer" type="radio" checked="checked"
								value="Direct bank transfer" name="direct-bank-transfer">Virement banquaire
						</div>

						<div class="info-label">Veillez spécifier votre numéro de commande quand vous faite votre virement. 
							La livraison sera effectuer une fois le montant de votre commande reçu.</div>
					</div>
				</div>
			</div>
